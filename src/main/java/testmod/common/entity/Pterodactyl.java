...
public class Pterodactyl extends FlyingMob implements Enemy, IAnimatable {
    ...
    /*public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes().add(Attributes.ATTACK_DAMAGE,(double) 6);
    }
   ...
   /* private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.pterodactyl.base_pose", true));
        if(isFlapping()) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.pterodactyl.move", true));
        }
